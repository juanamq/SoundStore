...
class InstrumentosModel extends CI_Model {
	...
	public function insertarInstrumento($nombre, $marca, $stock, $foto, $tipo, $color, $modelo, $precio, $fecha_registro, $estado) {
        $data = array(	
            'nombre' => $nombre,
			'marca' => $marca,
			'stock' => $stock,
	...
	public function cambiarEstadoInstrumento($id_instrumento, $estado) {
		$data = array(  
			'estado' => $estado
		);
