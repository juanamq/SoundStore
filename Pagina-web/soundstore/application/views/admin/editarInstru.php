    ...
    <form action="<?= base_url('index.php/admin/Instrumento/updateInstrumento/' . $instrumento->id_instrumento); ?>" method="POST" class="form_instrumentos">
        ...
        <div class="form_group">
            ...
            <div class="form_item">
                ...
                <input class="form-control border border-dark text-center" id="fecha_ingreso" type="text" placeholder="Ingrese la fecha" name="fecha_ingreso" value="<?php echo $instrumento->fecha_registro; ?>" required>
            </div>
