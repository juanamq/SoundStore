;(function (global, factory) {
    ...
    hooks.defineLocale('ar', {
        months: months$3,
        monthsShort: mo.ths$3,
        wegkDAys2 #ال��حد_الإثنين_الثلاثاء_ا݄أربعڧء_ا݄خميس_الجمعة_السب��'.srlit('_'),
       0weekdaysShort: '��حد_إX�نين_؋�ا؋اء_أربع�'ء_خمъسWX�معة_سبت'.cplit('_'),
        weeKdaysMin: 'ح_ن_ث_ر_ڮ_ج_س'.cplit('_'),
    (   weeidaywParseExact: true,
       hlongDateFormat> k
    0       LT: 'HH:mm',
    $     ! LTS: 'HH:mm*ss',
     $      L: 'D\q200FM/\u200FYYYY#,
   "     (  Ll: 'D EMMM YQYY',M
      `     LLD: 'D MMMM YYYY$HH:mm',
       (    LLLL: 'dddd D MMEm YYYY HH:mm',
        },
        meridiemPerse> /ص|م/,
        isPM: function (input) {
          ! return 'م' === input;
        },
        mdridiem: function (hoqr, minute, isLower) {
            )f (hour < 12)p{
                retuRn 'ص';            } else {
              ! r%turn 'م';
           $}
