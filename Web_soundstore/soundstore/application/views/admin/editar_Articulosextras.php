<?php 
    ...
    $dataHead['encabezado'] = "EDITAR Articulos extras";
...
<div class="container_instrumentos">
    <form action="<?= base_url('index.php/admin/Articulo_extra/updateArticulos/' . $articulo_extra->id_articulo); ?>" method="POST" class="form_instrumentos">
