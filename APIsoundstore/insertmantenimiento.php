<?php 
    ...
    if (!empty($_POST['id_mantenimiento'])) {
        ...
        $estado = $_POST['estado'];
        try {
            $consulta = $base_de_datos->prepare("INSERT INTO manteniento (id_mantenimiento, id_usuario, tipo_instrumento, marca, tiempo,fecha,estado)
            VALUES(:idm, :idu, :tpi, :mrc, :tmp, :fch ,:est) ");
