...
public class Adaptador_instrumento extends RecyclerView.Adapter< Adaptador_instrumento.ViewHolder >{
    ...
    @NonNull
    @Override
    public Adaptador_instrumento.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View vista = LayoutInflater.from(parent.getContext()).inflate(R.layout.detalle_instrumentos, parent, false);
        return new ViewHolder(vista);
    }

    @Override
    public void onBindViewHolder(@NonNull Adaptador_instrumento.ViewHolder holder, int position) {
