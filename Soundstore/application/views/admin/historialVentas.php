        ...
        <tbody>
            <?php foreach ($ventas as $venta) : ?>
                <tr>
                    ...
                    <td>
                        <a class="boton_editar_user" href="guardar_per/<?php echo $venta->id_historial_compras ?>">Editar</a>
                        <a class="boton_eliminar_user" href="borrar_per/<?php echo $venta->id_historial_compras ?>">Borrar</a>
                    </td>
                </tr>
            <?php endforeach ?>
        </tbody>
