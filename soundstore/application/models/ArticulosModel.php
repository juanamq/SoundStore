...
class ArticulosModel extends CI_Model {
	...
	public function insertarArticulos($nombre, $marca, $stock, $foto, $tipo, $color, $modelo, $precio, $fecha_registro, $estado) {
        $data = array(	
            'nombre' => $nombre,
			'marca' => $marca,
			'stock' => $stock,
	...
	public function cambiarEstadoArticulo($id_articulo, $estado) {
		$data = array(  
			'estado' => $estado
		);
